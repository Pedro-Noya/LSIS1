...
function showForm($dados){
    ...
    echo '<form action="atualizar_perfil.php" method="POST">
        ...
        Número de Identificação Fiscal: <input type="text" name="nif" placeholder="NIF" value="',$dados["nif"],'" readonly required><br>
        Número de Segurança Social: <input type="text" name="niss" placeholder="NISS" value="',$dados["niss"],'" readonly required><br>
        Número Cartão de Cidadão: <input type="text" name="cc" placeholder="CC" value="',$dados["cc"],'" readonly required><br>';

        $genero_array=["M","F"];
        #É correr o array genero_array e ver em qual indice o valor do genero é igual ao genero do colaborador em questão.
        echo 'Sexo: <select name="genero" required>';
        ...
        echo 'Situação IRS: <select name="situacaoIrs" required>';
        ...
        echo 'Telemóvel: <input type="text" name="contacto" placeholder="Telemóvel" value="', $dados["contacto"],'" required><br>';
        
        
        echo 'Email: <input type="text" name="email" placeholder="email" value="',$dados["email"],'" readonly required><br>
        IBAN: <input type="text" name="iban" placeholder="IBAN" value="',$dados["iban"],'" required><br>
        Contacto de Emergência: <input type="text" name="contactoEmergencia" placeholder="Nome" value="',$dados["contactoEmergencia"],'" required><br>
